...
export default function YeniIstatistik() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Mevcut en yüksek sıralama değerini al
      ...
      const nextSiralama = existingStats && existingStats.length > 0 
        ? existingStats[0].siralama + 1 
        : 1;
      ...
      alert('İstatistik eklenirken bir hata oluştu.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-8">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-2xl font-semibold text-white mb-6">Yeni İstatistik Ekle</h1>
